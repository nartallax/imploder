...
export class LoggerImpl implements Imploder.Logger {
	...
	error(str: string): void { this.logWithLevel(-2, str) }
	warn(str: string): void  { this.logWithLevel(-1, str) }
	info(str: string): void  { this.logWithLevel(-0, str) }
	debug(str: string): void { this.logWithLevel(1, str) }
